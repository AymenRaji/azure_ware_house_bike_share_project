...
# Create Rider table
table = "rider"
filename = 'azure-data-warehouse-projectdatafiles/Out/riders.csv'
create = "CREATE TABLE IF NOT EXISTS rider (rider_id INTEGER PRIMARY KEY, first VARCHAR(50), last VARCHAR(50), address VARCHAR(100), birthday DATE, account_start_date DATE, account_end_date DATE, is_member BOOLEAN);"
...
filename = 'azure-data-warehouse-projectdatafiles/Out/payments.csv'
...
table = "station"
filename = 'azure-data-warehouse-projectdatafiles/Out/stations.csv'
...
# Create Trip table
table = "trip"
filename = 'azure-data-warehouse-projectdatafiles/Out/trips.csv'
